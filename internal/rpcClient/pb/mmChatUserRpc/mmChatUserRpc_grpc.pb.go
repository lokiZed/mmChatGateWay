...
const (
	User_UserRegister_FullMethodName = "/mmChat.User/UserRegister"
	User_UserLogin_FullMethodName    = "/mmChat.User/UserLogin"
)
...
func (c *userClient) UserLogin(ctx context.Context, in *UserLoginReq, opts ...grpc.CallOption) (*UserLoginRes, error) {
...
func (UnimplementedUserServer) UserLogin(context.Context, *UserLoginReq) (*UserLoginRes, error) {
